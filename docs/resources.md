...
- [Technology Radar #26](https://www.thoughtworks.com/radar/tools/nuke) at Thoughtworks

# Videos 📺

- [Build Automation Revolution with NUKE](https://www.youtube.com/watch?v=E7CufNR84M4) by Matthias Koch at NDC Copenhagen 2022
...
- [Designing a Build System with IDE Support in Mind](https://www.youtube.com/watch?v=N57Zjb5-08I) by Matthias Koch at JetBrains Webinar
- [10 Ingredients for an AKEless Build System](https://www.youtube.com/watch?v=SVD70QYvQ6I) by Matthias Koch at .NET Fest Kyiv 2019
- [A Modern Build System for C#/.NET](https://www.youtube.com/watch?v=SwZi0B6_dQ0) 🇩🇪 by Matthias Koch at dev-days-online
- [A Modern Build System for C#/.NET](https://www.youtube.com/watch?v=U7TBrWo5Uag) by Matthias Koch at DotNext St. Petersburg 2019
- [Build automation for C# developers](https://www.youtube.com/watch?v=7gEqxzD6hbs) by Matthias Koch at DotNext Moscow 2017

# Podcasts 🎤

- [NUKE 5.0](https://dotnetrocks.com/?show=1716) with Matthias Koch on .NET Rocks!
- [Talking about NUKE](https://dotnetcore.show/episode-22-nuke-with-matthias-koch/) with Matthias Koch on dotnetcore.show
- [Cross-Platform CI/CD Automation Using NUKE](https://dotnetrocks.com/?show=1598) with Matthias Koch on .NET Rocks!
...
- From CAKE to Nuke by Duane Edwards
    - [Files in use and Visual Studio Active Build configuration](https://www.duaneedwards.net/from-cake-to-nuke-files-in-use-visual-studio-active-build-configurations/)
    - [Cleaning things up](https://www.duaneedwards.net/from-cake-to-nuke-1/)
...
- [Dude, where is my Build System? by Matthias Koch](https://medium.com/@matkoch87/dude-where-is-my-build-system-f0edc1668771)
- [Build Automation with C# and .NET Core by Matthias Koch](https://medium.com/@matkoch87/build-automation-with-c-and-net-core-9a42ebcf729d)
