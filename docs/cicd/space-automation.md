...
A full reference of available variables and their documentation can be found [here](https://nuke.greemdev.net/docfx/api/Nuke.Common.CI.SpaceAutomation.SpaceAutomation.html).